...
void itsnet_location_packet_list_free(
    struct list_head * location_packet_list);

void itsnet_location_packet_list_remove_packet(
    itsnet_location_packet * packet);
...
int itsnet_location_request (
    struct itsnet_packet *unicast_packet);

void itsnet_location_reply (
    struct itsnet_packet *p);

void itsnet_location_handler(
    struct itsnet_packet *p);
